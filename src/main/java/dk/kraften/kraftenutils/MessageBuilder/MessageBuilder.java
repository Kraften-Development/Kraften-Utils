package dk.kraften.kraftenbande.Builders.MessageBuilder;
...
import dk.kraften.kraftenbande.Builders.MessageBuilder.Objects.MessageMap;
import dk.kraften.kraftenbande.Utils.ColorTranslator;
...
public class MessageBuilder {
    ...
    protected String color(String string, boolean translate) {
        return translate ? ColorTranslator.string(string) : string;
    }
